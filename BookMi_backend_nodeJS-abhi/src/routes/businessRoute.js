...
businessRoute.route('/admin/all').get(async (req, res) => {
    let result = await businessController.getAllBusinessForAdminPortal(req)
    res.status(result.code).send(result)
})

businessRoute.route('/recommendedBusiness').get(async (req, res) => {
    let result = await businessController.recommendedBusiness(req)
    res.status(result.code).send(result)
})

businessRoute.route('/my').get(async (req, res) => {
    let result = await businessController.getMyBusiness(req)
    res.status(result.code).send(result)
})

businessRoute.route('/search').get(async (req, res) => {
    let result = await businessController.searchBusinessAndCategories(req)
    res.status(result.code).send(result)
})

businessRoute.route('/like').post(async (req, res) => {
    let result = await genericController.likePortfolioImage(req)
    res.status(result.code).send(result)
})
businessRoute.route('/report').post(async (req, res) => {
    let result = await genericController.reportBusiness(req)
    res.status(result.code).send(result)
})

businessRoute.route('/comment').post(async (req, res) => {
...
//     res.status(result.code).send(result);
//   })
businessRoute.route('/review').post(async (req, res) => {
    let result = await genericController.postBusinessReview(req)
    res.status(result.code).send(result)
})
businessRoute.route('/review/:reviewId').put(async (req, res) => {
    let result = await genericController.updateBusinessReview(req)
    res.status(result.code).send(result)
})
businessRoute.route('/review/:businessId').get(async (req, res) => {
...
businessRoute.route('/copy/service').get(async (req, res) => {
    let result =
        await businessServiceController.getServiceDetailsByBusinessMobile(req)
    res.status(result.code).send(result)
})
...
businessRoute
    ...
    .post(async (req, res) => {
        let result = await businessServiceController.createBusinessServiceMany(
            req
        )
        res.status(result.code).send(result)
    })
    .get(async (req, res) => {
        let result =
            await businessServiceController.getServiceDetailsBusinessId(req)
        res.status(result.code).send(result)
    })
...
businessRoute
    .route('/:businessId/service/:serviceId')
    .delete(async (req, res) => {
        let result = await businessServiceController.deleteBusinessService(req)
        res.status(result.code).send(result)
    })
